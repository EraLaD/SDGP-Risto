            ...
            <div class="box">
                <div class="col-lg-12 text-center">
                    ...
                    <h2>
						...
						<a href="file:///C:/Users/Erandi/Desktop/Correct%20Version%20of%20Akshina/Risto/filter.js-master/examples/pagination.html">Go Back & Choose Another Restaurant</a>					
            ...
            <div class="box">
                <div class="col-lg-12 ">
                    ...
                    <h2 class="intro-text text-center">
                        <strong>The Lagoon</strong>
                    </h2>
                    <hr>
                    <img class="img-responsive img-border img-left" src="img\restaurant1.jpg" alt="">
                    <hr class="visible-xs">
					<div id="d">
...
function myFunction(arr) {
    ...
    for(i = 0; i < arr.length; i++) {
        out += arr[i].long_description  
    }
    document.getElementById("d").innerHTML = out;
}
</script>
 <script src="data/myFunction.js"></script>
</body>
